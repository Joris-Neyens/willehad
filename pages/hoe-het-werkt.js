              ...
              <div className="row">
                <div className="col-12 offset-0 col-lg-6 offset-lg-3 mb-5">
                  ...
                  <p>
                    ...
                    alleen te doen. Laat jezelf uitdagen door anderen, stel
                    elkaar kritische vragen, hou elkaar verwantwoordelijk voor
                    de doelen die we onszelf zetten. Als we durven samen
                    uitdagende doelen te stellen en eerlijk zijn met elkaar
                    zullen we de vruchten in ons leven gaan zien.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    jij samen met anderen dieper gaan dan de inhoud van de
                    cursus in eerste instantie biedt. Deze cursus is voor
                    diegene die de uitdaging aan willen gaan om de diepte in te
                    gaan.
                  </p>
                  <p>
                    Je bent vrij om het cursus materiaal waar en wanneer je wilt
                    te volgen zolang je bij de wekelijkse bijeenkomst de inhoud
                    van die week klaar hebt. De groep is er niet alleen om jou
                  ...
                  <p>
                    ...
                    cursus materiaal. Een coach zal jou niet vertellen wat je
                    moet doen, maar zal kristische vragen stellen en jullie zelf
                    aan het werk zetten.
                  </p>
                  <p>
                    In de loop van het traject zul jij inhoudelijke vragen
                    krijgen die een expert vereisen. Als groep krijg je daarom
                  ...
                  <p>
                    Een cursus is bedoeld om ons op weg te helpen. Na de cursus
                    is het aan jou om deze weg op te gaan. Door samen met de
                    groep te blijven ontmoeten kun je elkaar hierin steunen.
                  </p>
                  <p>
