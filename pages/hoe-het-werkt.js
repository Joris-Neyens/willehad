            ...
            <div className="container hoe-het-werkt">
              ...
              <div className="row">
                <div className="col-12 offset-0 col-lg-6 offset-lg-3 mb-5">
                  ...
                  <p>
                    Je bent vrij om het cursus materiaal waar en wanneer je wilt te volgen zolang je bij de wekelijkse bijeenkomst de inhoud van die week klaar
                    hebt. De groep is er niet alleen om jou uit te dagen, jou inbreng zal de anderen in jou groep ook scherp houden.
                  </p>
                  ...
                  <p>
                    Wij blijven ons inzetten om relevante cursussen te ontwikkelen. Als groep kun je er altijd voor kiezen om samen een nieuwe cursus te volgen
                    om weer volgende stappen te zetten.
                  </p>
                  <div className="d-flex justify-content-center">
                    <Link href="/cursus-aanbod">
                      <button className="button__primary mt-3 px-3">Cursus aanbod</button>
                    </Link>
                  </div>
                </div>
              </div>
